    ...
    <main className="min-h-screen px-6 pt-32 pb-20">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-syne font-extrabold text-3xl md:text-4xl
            tracking-tight text-theme">
            Build your perfect palette
          </h1>
          <p className="text-muted2 text-sm mt-3">
        ...
        {/* Step content */}
        <div className="bg-theme-surface border border-theme rounded-2xl p-8">
          {step === 1 && <StepOne />}
          {step === 2 && <StepTwo />}
          {step === 3 && <StepThree />}
          {step === 4 && <StepFour />}
